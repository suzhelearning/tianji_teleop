...
class TargetManager {
 ...
 private:
  ...
  Pose conditionManualTarget(ArmSide side, const Pose& requested);
  ...
  DexhandTargetConditioner left_pre_ik_conditioner_;
  DexhandTargetConditioner right_pre_ik_conditioner_;
