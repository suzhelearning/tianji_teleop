...
# The single-page UI ships inside the package rather than beside it.
_WEB_DIR = files("data_collector").joinpath("web")
    ...
    def do_GET(self):
        try:
            ...
            if target.path == '/':
                ...
                body = _WEB_DIR.joinpath("visualize.html").read_bytes()
