...
below are from the vendored ManusSDKTypes.h header (vendor/manus_sdk/include).
SDK VUH positions are right-handed world-space meters and retain their original
handedness.
