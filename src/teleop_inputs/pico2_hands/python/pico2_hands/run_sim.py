...
def main(argv=None):
    ...
    try:
        with ExitStack() as stack:
            ...
            config = controller_profile("qp_ik_pico_shared_root_dls.yaml") if shared_root else ROOT / "config/simulation.yaml"
            simulation = DirectStateSimulation(display_model_path(model), config)
