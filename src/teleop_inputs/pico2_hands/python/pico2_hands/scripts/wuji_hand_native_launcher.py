...
def _manifest(official, left_config, right_config, selected_side):
...
def main():
    ...
    left_config = (args.left_config or official / "example/config/adaptive_analytical_manus_wuji_hand_2_left.yaml").resolve(strict=True)
    right_config = (args.right_config or official / "example/config/adaptive_analytical_manus_wuji_hand_2_right.yaml").resolve(strict=True)
    ...
    try:
        manifest.write_bytes(_manifest(official, left_config, right_config, args.single_hand_side))
