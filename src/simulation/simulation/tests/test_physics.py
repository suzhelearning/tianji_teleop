...
# Model and profile are description/controller resources. The installed copy
# wins; the source tree keeps the suite runnable before a workspace build.
def _model() -> Path:
    from tianji_runtime import package_share, workspace
