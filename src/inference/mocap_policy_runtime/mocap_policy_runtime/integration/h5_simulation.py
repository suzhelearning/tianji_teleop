...
from .native import NativeIK, pose_xyzw, robot_config
...
class H5SimulationSession:
    ...
    def render_overlay(self, scene, now=None, *, clear=True):
        ...
        if self._reference_overlay is None:
            import mujoco
            from tianji_controller.viewer import ReferenceOverlay
...
def main(argv=None):
    ...
    from simulation.physics import PhysicsSimulation
