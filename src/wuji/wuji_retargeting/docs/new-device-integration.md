...
```bash
python -m example.teleop_sim --play data/my_device_sample.pkl --hand right \
...
```bash
python -m example.tuning_tool --play data/my_device_sample.pkl --hand right \
    --config config/adaptive_analytical_my_device.yaml
```
...
```bash
# Simulation
python -m example.teleop_sim --input my_device --hand right \
    --config config/adaptive_analytical_my_device.yaml

# Real hardware
python -m example.teleop_real --input my_device --hand right \
    --config config/adaptive_analytical_my_device.yaml
```
