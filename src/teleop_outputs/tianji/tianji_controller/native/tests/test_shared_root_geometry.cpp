...
TEST(SharedRootGeometry, PalmTcpExtensionIsIsolatedFromLegacyModel) {
  MujocoRobot legacy(TIANJI_MODEL_DIR "/marvin_m6_wuji2.xml");
  MujocoRobot palm(TIANJI_MODEL_DIR "/marvin_m6_wuji2_shared_root.xml");
...
TEST(SharedRootGeometry, FixedShoulderRootAndCrossModelFrames) {
  MujocoRobot robot(TIANJI_MODEL_DIR "/marvin_m6_wuji2_shared_root.xml");
