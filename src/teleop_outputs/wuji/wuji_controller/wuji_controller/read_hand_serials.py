...
# Resolved through the vendor authority so the checkout layout and any
# relocation are handled in one place.
DEFAULT_LIBRARY = vendor_path("wuji-sdk", "lib", "libwuji_sdk_c.so")
