...
import unittest
import zlib
from .test_mapped_palm_port import DESCRIPTION, BUILD, packet
from tianji_controller.run_teleop import CommandReceiver
from tianji_controller.mapped_events import EventReceiver
...
class NativeEventTests(unittest.TestCase):
    ...
    def exercise(self, timeout, dropout=False):
        ...
        args=[str(BUILD/'mapped_palm_tjrc_controller'),
              '--config',str(DESCRIPTION/'config/deployment.yaml'),'--model',str(DESCRIPTION/'mapped_palm/assets/mapped_palm/marvin_m6_wuji2.xml'),
