...
SDK_HEADER = vendor_path("wuji-sdk", "include")
# Handedness discovery is hand I/O, so it lives with the hand adapter.
MODULE = "wuji_controller.read_hand_serials"
...
class ReadHandSerialsTests(unittest.TestCase):
    ...
    def run_cli(self, *args, extra_env=None):
        ...
        return subprocess.run([sys.executable, "-m", MODULE, "--sdk-library", str(self.library),
