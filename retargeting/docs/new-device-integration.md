...
```bash
.venv/bin/python -m retargeting.example.teleop_sim --play data/my_device_sample.pkl --hand right \
...
```bash
.venv/bin/python -m retargeting.example.tuning_tool --play data/my_device_sample.pkl --hand right \
    --config config/adaptive_analytical_my_device.yaml
```
...
```bash
# Simulation
.venv/bin/python -m retargeting.example.teleop_sim --input my_device --hand right \
    --config config/adaptive_analytical_my_device.yaml

# Real hardware
.venv/bin/python -m retargeting.example.teleop_real --input my_device --hand right \
    --config config/adaptive_analytical_my_device.yaml
```
