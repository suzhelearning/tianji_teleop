...
struct HierarchicalQpProblem {
  ...
  VectorNullspaceTask vector_nullspace_task;
...
struct VelocityQpSmoothnessCosts {
  double full_acceleration{0.0};
  double full_jerk{0.0};
  double nullspace_acceleration{0.0};
  double nullspace_jerk{0.0};
};
