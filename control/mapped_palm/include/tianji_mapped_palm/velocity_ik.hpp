...
struct ArmIkResult {
  ...
  double smoothness_full_acceleration_cost{0.0};
  double smoothness_full_jerk_cost{0.0};
  double smoothness_nullspace_acceleration_cost{0.0};
  double smoothness_nullspace_jerk_cost{0.0};
