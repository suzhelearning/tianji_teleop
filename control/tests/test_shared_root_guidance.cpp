...
namespace {
constexpr auto kXml=TIANJI_PROJECT_SOURCE_DIR "/models/marvin_m6_wuji2_shared_root.xml";
constexpr auto kUrdf=TIANJI_PROJECT_SOURCE_DIR "/models/marvin_m6_s_ccs_696_v4_local.urdf";
...
TEST_F(SharedRootGuidance, CannotMixWrongPostureModeOrWrongModelTcp) {
  ...
  MujocoRobot other(TIANJI_PROJECT_SOURCE_DIR "/models/marvin_m6_qp_test.xml");
