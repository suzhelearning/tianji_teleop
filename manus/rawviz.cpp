...
//
// stdout protocol for manus_hand_input.py (one record per line):
...
// Default: <exe directory>/../calibration, for manus/build/manus_raw.
	...
	for (int i = 1; i < argc; i++)
	{
		if (strcmp(argv[i], "--help") == 0 || strcmp(argv[i], "-h") == 0)
		{
			printf("Usage: %s [--user NAME] [--calibration-dir PATH]\n"
			       ...
			       "Calibration defaults to ../calibration relative to the executable.\n"
